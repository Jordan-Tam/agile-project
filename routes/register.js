...
function validateUserId(value) {
  ...
  if (!/^[a-zA-Z0-9]+$/.test(s)) throw "userId can only contain letters and numbers.";
...
router.post("/register", async (req, res) => {
  try {
    ...
    const password  = validatePassword(xss(req.body.password), xss(req.body.confirmPassword));
